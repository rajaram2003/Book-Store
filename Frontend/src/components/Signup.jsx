  ...
  <div className="modal-box">
    ...
    <div className="mt-5 space-y-2">
     ...
     <div className="flex justify-around mt-5">
      <button className="bg-pink-500 text-white rounded-md px-3 py-1 hover:bg-pink-700 duration-200" onClick={()=>document.getElementById("my_modal_3").showModal()}>Signup</button>

  <p className="text-xl">
  Have account?{" "}
  <button className="underline text-pink-500 hover:text-pink-700" onClick={() => document.getElementById("my_modal_3").showModal()}>
  Login
  </button>
  <Login/>
  </p>
